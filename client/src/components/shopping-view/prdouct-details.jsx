    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 sm:p-8 max-w-[95vw] md:max-w-[80vw] lg:max-w-[70vw] max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex flex-col justify-between h-full space-y-4">
          <div>
            {/* Title & Description */}
            <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-foreground">{productdetails?.title}</h1>
            ...
            {/* Add to Cart */}
            <div className="mt-6">
              <Button onClick={()=>handleAddtoCart(productdetails?._id)} className="w-full py-6 text-base font-semibold">Add To Cart</Button>
            </div>
          </div>
            ...
            <div className="flex-1 overflow-y-auto space-y-4 pr-1 mb-4">
              ...
              <div className="flex gap-3 items-start bg-muted/30 p-3 rounded-lg">
                ...
                <div className="flex-1 space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">This is an awesome Product</p>
                </div>
              </div>
            </div>
